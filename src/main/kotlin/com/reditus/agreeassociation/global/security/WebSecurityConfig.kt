...
class WebSecurityConfig(
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        http.addFilterBefore({ servletRequest, servletResponse, filterChain ->
            ...
            } catch (e: NotAuthorizationException) {
                val response = servletResponse as HttpServletResponse
                sendError(response, "UNAUTHORIZED", "인증이 필요합니다.",401)
            }
        }, AuthorizationJwtHeaderFilter::class.java)
    ...
    fun corsConfigSource(): CorsConfigurationSource {
        ...
        configuration.exposedHeaders = Arrays.asList("Authorization", "Set-cookie")
